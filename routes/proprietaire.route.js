...
const { signUp, signinUser, getAll, getOneUser, addNewBien, addNewLocataire, deleteBien, updateBien, deleteLocataire, updateLocataire, getBien, getLocataire } = require('../controllers/proprietaire.controller');
